...
RSpec.describe Key do
  ...
  describe 'initialize' do
    ...
    it 'has a key by default' do
      new_key = Key.new

      expect(new_key.key.length).to eq(5)
    end

    it 'has a date by default' do
      new_key = Key.new

      expect(new_key.date.length).to eq(6)
    end

    it 'can take in a key' do
      new_key = Key.new('02715')

      expect(new_key.key).to eq('02715')
    end

    it 'can take in a date' do
      new_key = Key.new('02715', '040895')

      expect(new_key.date).to eq('040895')
    end
  end

  describe '#a_shift' do
    it 'shifts first letter a given amount' do
      new_key = Key.new('02715', '040895')

      expect(new_key.a_shift).to eq(3)
    end
  end
  ...
  describe '#b_shift' do
    it 'shifts first letter a given amount' do
      ...
      expect(new_key.b_shift).to eq(27)
    end
  end
  ...
  describe '#c_shift' do
    it 'shifts first letter a given amount' do
      ...
      expect(new_key.c_shift).to eq(73)
    end
  end
  ...
  describe '#d_shift' do
    it 'shifts first letter a given amount' do
      ...
      expect(new_key.d_shift).to eq(20)
    end
  end
end
